...
def main():
    data_path = "E:\\file\\NUS\\NUS-cat\\NUS-Robotics-DL-project\\advanced\\all_dataset"
    train_cross_validation(MODEL_FILE, data_path, num_hidden=200, num_classes=5, steps=120, num_epochs=30, k_folds=5)
